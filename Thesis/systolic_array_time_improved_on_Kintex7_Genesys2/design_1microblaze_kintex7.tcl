...
xilinx.com:user:Axi_lite_interface:1.0\
...
proc write_mig_file_design_1_mig_7series_0_5 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>design_1_mig_7series_0_5</ModuleName>}
   ...
   puts $mig_prj_file {    <MMCMClkOut0>26.625</MMCMClkOut0>}
...
# End of write_mig_file_design_1_mig_7series_0_5()
...
proc create_root_design { parentCell } {
  ...
  write_mig_file_design_1_mig_7series_0_5 $str_mig_file_path
  ...
  # Create instance: Axi_lite_interface_0, and set properties
  set Axi_lite_interface_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Axi_lite_interface:1.0 Axi_lite_interface_0 ]
  ...
  # Create instance: SysA_interface_pipe1_0, and set properties
  set block_name SysA_interface_pipe1
  set block_cell_name SysA_interface_pipe1_0
  if { [catch {set SysA_interface_pipe1_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $SysA_interface_pipe1_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {s00_axis:m00_axis} \
 ] [get_bd_pins /SysA_interface_pipe1_0/s00_axi_aclk]

  # Create interface connections
  connect_bd_intf_net -intf_net SysA_interface_pipe1_0_m00_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins SysA_interface_pipe1_0/m00_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets SysA_interface_pipe1_0_m00_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets SysA_interface_pipe1_0_m00_axis]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins SysA_interface_pipe1_0/s00_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_0/S04_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_DC [get_bd_intf_pins microblaze_0/M_AXI_DC] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_DP [get_bd_intf_pins microblaze_0/M_AXI_DP] [get_bd_intf_pins microblaze_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_M_AXI_IC [get_bd_intf_pins microblaze_0/M_AXI_IC] [get_bd_intf_pins axi_interconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M00_AXI [get_bd_intf_pins microblaze_0_axi_periph/M00_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins Axi_lite_interface_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net Axi_lite_interface_0_control_sig [get_bd_pins Axi_lite_interface_0/control_sig] [get_bd_pins system_ila_0/probe2] [get_bd_pins SysA_interface_pipe1_0/control_sel]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets Axi_lite_interface_0_control_sig]
  connect_bd_net -net SYS_Rst_1 [get_bd_pins proc_sys_reset_1/bus_struct_reset] [get_bd_pins microblaze_0_local_memory/SYS_Rst]
  connect_bd_net -net SysA_interface_pipe1_0_Abusy [get_bd_pins SysA_interface_pipe1_0/Abusy] [get_bd_pins system_ila_0/probe7]
  connect_bd_net -net SysA_interface_pipe1_0_Acol [get_bd_pins SysA_interface_pipe1_0/Acol] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net SysA_interface_pipe1_0_Arow [get_bd_pins SysA_interface_pipe1_0/Arow] [get_bd_pins system_ila_0/probe5]
  connect_bd_net -net SysA_interface_pipe1_0_Transfer0 [get_bd_pins SysA_interface_pipe1_0/Transfer0] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net SysA_interface_pipe1_0_current_state [get_bd_pins SysA_interface_pipe1_0/current_state] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net SysA_interface_pipe1_0_job_count [get_bd_pins SysA_interface_pipe1_0/job_count] [get_bd_pins system_ila_0/probe6]
  connect_bd_net -net Transfer0 [get_bd_pins SysA_interface_pipe1_0/Store0] [get_bd_pins system_ila_0/probe1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets Transfer0]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_0/S03_ACLK] [get_bd_pins system_ila_0/clk] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_interconnect_0/S04_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins SysA_interface_pipe1_0/s00_axi_aclk]
  connect_bd_net -net mdm_1_Debug_SYS_Rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins proc_sys_reset_1/mb_debug_sys_rst]
  connect_bd_net -net mig_7series_0_mmcm_locked [get_bd_pins mig_7series_0/mmcm_locked] [get_bd_pins proc_sys_reset_1/dcm_locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins Axi_lite_interface_0/s00_axi_aclk]
  connect_bd_net -net mig_7series_0_ui_clk_sync_rst [get_bd_pins mig_7series_0/ui_clk_sync_rst] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_0/S03_ARESETN] [get_bd_pins system_ila_0/resetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins axi_interconnect_0/S04_ARESETN] [get_bd_pins SysA_interface_pipe1_0/s00_axi_aresetn]
  connect_bd_net -net proc_sys_reset_1_mb_reset [get_bd_pins proc_sys_reset_1/mb_reset] [get_bd_pins microblaze_0/Reset]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins Axi_lite_interface_0/s00_axi_aresetn]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs Axi_lite_interface_0/S00_AXI/S00_AXI_reg] -force
